...
def get_data_info():
    # Open our csv
    file = open('Population with StatSig.csv')
...
<ul>
	...
	<ul style="list-style-type:circle">
		<li>{round(datalist[0] * 100 - datalist[1] * 100, 1)} points from {round(datalist[1] * 100, 1)}% during {years_strings[1]}. {statsiglist[0]}</li>
		<li>{round(datalist[0] * 100 - datalist[2] * 100, 1)} points from {round(datalist[2] * 100, 1)}% during {years_strings[2]}. {statsiglist[1]}</li>
	</ul>
	</li>
	<li>White (Non-Hispanic) was {round(datalist[3] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(datalist[3] * 100 - datalist[4] * 100, 1)} points from {round(datalist[4] * 100, 1)}% during {years_strings[1]}. {statsiglist[2]}</li>
		<li>{round(datalist[3] * 100 - datalist[5] * 100, 1)} points from {round(datalist[5] * 100, 1)}% during {years_strings[2]}. {statsiglist[3]}</li>
	</ul>
	</li>
	<li>Black or African-American (Non-Hispanic) was {round(datalist[6] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(datalist[6] * 100 - datalist[7] * 100, 1)} points from {round(datalist[7] * 100, 1)}% during {years_strings[1]}. {statsiglist[4]}</li>
		<li>{round(datalist[6] * 100 - datalist[8] * 100, 1)} points from {round(datalist[8] * 100, 1)}% during {years_strings[2]}. {statsiglist[5]}</li>
	</ul>
	</li>
	<li>American Indian (Non-Hispanic) was {round(datalist[9] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(datalist[9] * 100 - datalist[10] * 100, 1)} points from {round(datalist[10] * 100, 1)}% during {years_strings[1]}. {statsiglist[6]}</li>
		<li>{round(datalist[9] * 100 - datalist[11] * 100, 1)} points from {round(datalist[11] * 100, 1)}% during {years_strings[2]}. {statsiglist[7]}</li>
	</ul>
	</li>
	<li>Asian (Non-Hispanic) was {round(datalist[12] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(datalist[12] * 100 - datalist[13] * 100, 1)} points from {round(datalist[13] * 100, 1)}% during {years_strings[1]}. {statsiglist[8]}</li>
		<li>{round(datalist[12] * 100 - datalist[14] * 100, 1)} points from {round(datalist[14] * 100, 1)}% during {years_strings[2]}. {statsiglist[9]}</li>
	</ul>
	</li>
	<li>Native Hawaiian &amp; Pacific Islander (Non-Hispanic) was {round(datalist[15] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(datalist[15] * 100 - datalist[16] * 100, 1)} points from {round(datalist[16] * 100, 1)}% during {years_strings[1]}. {statsiglist[10]}</li>
		<li>{round(datalist[15] * 100 - datalist[17] * 100, 1)} points from {round(datalist[17] * 100, 1)}% during {years_strings[2]}. {statsiglist[11]}</li>
	</ul>
	</li>
	<li>Some other race was {round(datalist[18] * 100, 1)}%, changing by:
	<ul style="list-style-type:circle">
		<li>{round(datalist[18] * 100 - datalist[19] * 100, 1)} points from {round(datalist[19] * 100, 1)}% during {years_strings[1]}. {statsiglist[12]}</li>
		<li>{round(datalist[18] * 100 - datalist[20] * 100, 1)} points from {round(datalist[20] * 100, 1)}% during {years_strings[2]}. {statsiglist[13]}</li>
	</ul>
	</li>
	<li>Two or more races was {round(datalist[21] * 100, 1)}%, changing by:
	<ul style="list-style-type:circle">
		<li>{round(datalist[21] * 100 - datalist[22] * 100, 1)} points from {round(datalist[22] * 100, 1)}% during {years_strings[1]}. {statsiglist[14]}</li>
		<li>{round(datalist[21] * 100 - datalist[23] * 100, 1)} points from {round(datalist[23] * 100, 1)}% during {years_strings[2]}. {statsiglist[15]}</li>
	</ul>
	</li>
</ul>\n''', file=f)
...
<ul>
	...
	<ul style="list-style-type:circle">
		<li>{round(wadatalist[0] * 100 - wadatalist[1] * 100, 1)} points from {round(wadatalist[1] * 100, 1)}% during  {years_strings[1]}. {siglistwa[0]} </li>
		<li>{round(wadatalist[0] * 100 - wadatalist[2] * 100, 1)} points from {round(wadatalist[2] * 100, 1)}% during  {years_strings[2]}. {siglistwa[1]}</li>
	</ul>
	</li>
	<li>White (Non-Hispanic) was {round(wadatalist[3] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(wadatalist[3] * 100 - wadatalist[4] * 100, 1)} points from {round(wadatalist[4] * 100, 1)}% during  {years_strings[1]}. {siglistwa[2]} </li>
		<li>{round(wadatalist[3] * 100 - wadatalist[5] * 100, 1)} points from {round(wadatalist[5] * 100, 1)}% during  {years_strings[2]}. {siglistwa[3]}</li>
	</ul>
	</li>
	<li>Black or African-American (Non-Hispanic) was {round(wadatalist[6] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(wadatalist[6] * 100 - wadatalist[7] * 100, 1)} points from {round(wadatalist[7] * 100, 1)}% during  {years_strings[1]}. {siglistwa[4]} </li>
		<li>{round(wadatalist[6] * 100 - wadatalist[8] * 100, 1)} points from {round(wadatalist[8] * 100, 1)}% during  {years_strings[2]}. {siglistwa[5]}</li>
	</ul>
	</li>
	<li>American Indian (Non-Hispanic) was {round(wadatalist[9] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(wadatalist[9] * 100 - wadatalist[10] * 100, 1)} points from {round(wadatalist[10] * 100, 1)}% during  {years_strings[1]}. {siglistwa[6]} </li>
		<li>{round(wadatalist[9] * 100 - wadatalist[11] * 100, 1)} points from {round(wadatalist[11] * 100, 1)}% during  {years_strings[2]}. {siglistwa[7]}</li>
	</ul>
	</li>
	<li>Asian (Non-Hispanic) was {round(wadatalist[12] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(wadatalist[12] * 100 - wadatalist[13] * 100, 1)} points from {round(wadatalist[13] * 100, 1)}% during  {years_strings[1]}. {siglistwa[8]} </li>
		<li>{round(wadatalist[12] * 100 - wadatalist[14] * 100, 1)} points from {round(wadatalist[14] * 100, 1)}% during  {years_strings[2]}. {siglistwa[9]}</li>
	</ul>
	</li>
	<li>Native Hawaiian &amp; Pacific Islander (Non-Hispanic) was {round(wadatalist[15] * 100, 1)}%, changing by: 
	<ul style="list-style-type:circle">
		<li>{round(wadatalist[15] * 100 - wadatalist[16] * 100, 1)} points from {round(wadatalist[16] * 100, 1)}% during  {years_strings[1]}. {siglistwa[10]} </li>
		<li>{round(wadatalist[15] * 100 - wadatalist[17] * 100, 1)} points from {round(wadatalist[17] * 100, 1)}% during  {years_strings[2]}. {siglistwa[11]}</li>
	</ul>
	</li>
	<li>Some other race was {round(wadatalist[18] * 100, 1)}%, changing by:
	<ul style="list-style-type:circle">
		<li>{round(wadatalist[18] * 100 - wadatalist[19] * 100, 1)} points from {round(wadatalist[19] * 100, 1)}% during  {years_strings[1]}. {siglistwa[12]} </li>
		<li>{round(wadatalist[18] * 100 - wadatalist[20] * 100, 1)} points from {round(wadatalist[20] * 100, 1)}% during  {years_strings[2]}. {siglistwa[13]}</li>
	</ul>
	</li>
	<li>Two or more races was {round(wadatalist[21] * 100, 1)}%, changing by:
	<ul style="list-style-type:circle">
		<li>{round(wadatalist[21] * 100 - wadatalist[22] * 100, 1)} points from {round(wadatalist[22] * 100, 1)}% during  {years_strings[1]}. {siglistwa[14]} </li>
		<li>{round(wadatalist[21] * 100 - wadatalist[23] * 100, 1)} points from {round(wadatalist[23] * 100, 1)}% during  {years_strings[2]}. {siglistwa[15]}</li>
	</ul>
	</li>
</ul>
